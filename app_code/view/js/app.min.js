...
{
	lightOn = !lightOn;
    let NaviList = document.getElementsByTagName('NavigationInfo')
    for (let index = 0; index < NaviList.length; index++) {
        NaviList[index].setAttribute('headlight', lightOn.toString())
    }
}
...
function cameraUp () {
    if(select_md == 0) {
        document.getElementById('model__ctop0').setAttribute('bind', 'true');
    } else if(select_md == 1) {
        document.getElementById('model__ctop1').setAttribute('bind', 'true');
    } else if(select_md == 2) {
        document.getElementById('model__ctop2').setAttribute('bind', 'true');
    } 
}
// Look Bottom
function cameraDown () {
    if(select_md == 0) {
        document.getElementById('model__cbottom0').setAttribute('bind', 'true');
    } else if(select_md == 1) {
        document.getElementById('model__cbottom1').setAttribute('bind', 'true');
    } else if(select_md == 2) {
        document.getElementById('model__cbottom2').setAttribute('bind', 'true');
    } 
}
